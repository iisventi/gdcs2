...
- **Invert**: __Inverts the movement of the wave__ so that it spawns waves that go from the edge of the screen to the center.
 - **Inner**: __How big the radius of distortion is from the center of the screen. Basically creates a circle you set the size of that distorts the area it is in as waves get to it.
